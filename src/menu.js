...
const makeItem = (imgSrc, p, i) => {
  ...
  mora.src = "../dist/assets/mora.webp";
  mora.className = "mora";
...
const makeMenu = () => {
  ...
  const drinkItems = {
    item1: {
      1: "../dist/assets/item_apple_cider.webp",
      2: "1500",
    ...
    item2: {
      1: "../dist/assets/item_mint_burst.webp",
      2: "1500",
    ...
    item3: {
      1: "../dist/assets/item_sparkling_berry_juice.webp",
      2: "1500",
    ...
    item4: {
      1: "../dist/assets/item_Wolfhook_Juice.webp",
      2: "1500",
  ...
  const dishItem = {
    item1: {
      1: "../dist/assets/item_Mondstadt_Hash_Brown.webp",
      2: "1200",
    ...
    item2: {
      1: "../dist/assets/item_Barbatos_Ratatouille.webp",
      2: "2500",
    ...
    item3: {
      1: "../dist/assets/item_Super_Magnificent_Pizza.webp",
      2: "2200",
    ...
    item4: {
      1: "../dist/assets/item_pile_up.webp",
      2: "1900",
